...
class Shell:
    ...
    def run(self, command: str, capture: bool = False, text: bool = True, cwd: str = None, env: dict = None) -> Optional[subprocess.CompletedProcess]:
        if capture:
            return self.captured_run(command, text=text, cwd=cwd, env=env)
        else:
            self.live_run(command, text=text, cwd=cwd, env=env)

    def captured_run(self, command: str, text: bool = True, cwd: str = None, env: dict = None):
    ...
    def live_run(self, command: str, text: bool = True, cwd: str = None, env: dict = None):
